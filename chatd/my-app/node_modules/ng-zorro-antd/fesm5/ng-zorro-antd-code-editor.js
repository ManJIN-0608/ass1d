import { InjectionToken, Injectable, Inject, ɵɵdefineInjectable, ɵɵinject, Component, ChangeDetectionStrategy, ViewEncapsulation, forwardRef, NgZone, ElementRef, Input, Output, EventEmitter, NgModule } from '@angular/core';
import { __assign, __spread, __read, __decorate, __metadata } from 'tslib';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import { of, Subject, BehaviorSubject, combineLatest, fromEvent } from 'rxjs';
import { tap, map, takeUntil, debounceTime, filter, distinctUntilChanged } from 'rxjs/operators';
import { PREFIX, inNextTick, warn, InputBoolean } from 'ng-zorro-antd/core';
...
var NzCodeEditorService = /** @class */ (function () {
    ...
    /** @nocollapse */ NzCodeEditorService.ngInjectableDef = ɵɵdefineInjectable({ factory: function NzCodeEditorService_Factory() { return new NzCodeEditorService(ɵɵinject(NZ_CODE_EDITOR_CONFIG), ɵɵinject(DOCUMENT)); }, token: NzCodeEditorService, providedIn: "root" });
