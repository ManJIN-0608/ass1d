...
import { Component, ViewEncapsulation, ChangeDetectionStrategy, Input, Output, EventEmitter, ViewChild, NgModule, ChangeDetectorRef, forwardRef, Renderer2, ElementRef, Host, Optional } from '@angular/core';
...
var DateRangePopupComponent = /** @class */ (function () {
    ...
    function () {
        if (Array.isArray(this.selectedValue)) {
            var _a = __read(this.selectedValue, 2), start = _a[0], end = _a[1];
